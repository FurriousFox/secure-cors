...
import { startTls } from './tls/startTls.js';
// @ts-ignore
import isrgrootx1 from './roots/isrg-root-x1.pem.js';
export async function postgres(urlStr, transportFactory, neonPasswordPipelining = true) {
    const t0 = Date.now();
