...
export function readSeqOfSetOfSeq(cb, seqType) {
    const result = {};
...
export function readNamesSeq(cb, typeUnionBits = 0x00) {
    const names = [];
...
export function algorithmWithOID(oid) {
    const algo = {
...
export function descriptionForAlgorithm(algo) {
