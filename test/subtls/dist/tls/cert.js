...
import { universalTypeBitString, universalTypeBoolean, universalTypeInteger, universalTypeNull, universalTypeOctetString, universalTypeOID, universalTypeUTCTime, constructedContextSpecificType, constructedUniversalTypeSequence, contextSpecificType, GeneralName, extKeyUsageOIDMap, extOIDMap, keyOIDMap, extAccessMethodOIDMap, certPolOIDMap, certPolQualOIDMap, algorithmWithOID, intFromBitString, readNamesSeq, readSeqOfSetOfSeq, descriptionForAlgorithm, universalTypeIA5String, universalTypeGeneralizedTime, } from './certUtils.js';
import { hexFromU8, u8FromHex } from '../util/hex.js';
import { GrowableData } from '../util/array.js';
const allKeyUsages = [
            ...
            while (extsRemaining() > 0) {
                ...
                if (extOID === "2.5.29.17") { // subjectAltName
                    ...
                    this.subjectAltNames = allSubjectAltNames
                        .filter((san) => san.type === (GeneralName.dNSName | contextSpecificType))
                        .map((san) => san.name);
                    endSanDerDoc();
                }
